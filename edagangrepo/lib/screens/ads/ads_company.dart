...
class BlurbCompanyPage extends StatefulWidget {
  String bizId, bizName;
  BlurbCompanyPage(this.bizId, this.bizName);

  @override
  _BlurbCompanyPageState createState() {
    return new _BlurbCompanyPageState();
  }
}

class _BlurbCompanyPageState extends State<BlurbCompanyPage> {
