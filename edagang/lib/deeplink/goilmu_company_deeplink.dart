...
class GoilmuCompanyDlPage extends StatefulWidget {
  String bizId, bizName;
  GoilmuCompanyDlPage(this.bizId, this.bizName);

  @override
  _GoilmuCompanyDlPageState createState() {
    return new _GoilmuCompanyDlPageState();
  }
}

class _GoilmuCompanyDlPageState extends State<GoilmuCompanyDlPage> {
  ...
  @override
  void initState() {
    FirebaseAnalytics().logEvent(name: 'Deeplink_Goilmu_Company'+widget.bizName,parameters:null);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ScopedModel<Upskill2ScopedModel>(
      ...
      child: Scaffold(
        ...
        body: GoilmuCourseListDlPage(int.parse(widget.bizId)),
      ),
    );
  }
...
class GoilmuCourseListDlPage extends StatefulWidget {
  int bizId;
  GoilmuCourseListDlPage(this.bizId);

  @override
  _GoilmuCourseListDlBodyState createState() {
    return new _GoilmuCourseListDlBodyState(bizId: null);
  }
}
...
class _GoilmuCourseListDlBodyState extends State<GoilmuCourseListDlPage> {
  ...
  final int bizId;
  _GoilmuCourseListDlBodyState({@required this.bizId});
  ...
  Widget build(BuildContext context) {
    ...
    return ScopedModelDescendant<Upskill2ScopedModel>(
      builder: (context, child, model) {
        this.model = model;
        return model.isLoadingGo ? buildCircularProgressIndicator() : model.goilmuCourses.length > 0 ? CustomScrollView(
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              leading: Hero(
                  tag: "back",
                  child: InkWell(
                    onTap: () {Navigator.pushReplacement(context, SlideRightRoute(page: NewHomePage(3)));},
