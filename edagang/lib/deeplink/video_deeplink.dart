...
class VideoPlayDl extends StatefulWidget {
  String vid,title;
  VideoPlayDl(this.vid, this.title);

  @override
  _VideoPlayDlState createState() => _VideoPlayDlState();
}

class _VideoPlayDlState extends State<VideoPlayDl> {
  ...
  @override
  void initState() {
    FirebaseAnalytics().logEvent(name: 'Deeplink_Cartsini_video_'+widget.title,parameters:null);
    super.initState();
