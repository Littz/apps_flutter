...
class MerchantRegister extends StatefulWidget {
  final url, title;
  MerchantRegister(this.url, this.title);
  @override
  _MerchantRegisterState createState() => _MerchantRegisterState(this.url, this. title);
}

class _MerchantRegisterState extends State<MerchantRegister> {
  var _url, _title;
  _MerchantRegisterState(this._url, this._title);
  String selectedUrl = '';
