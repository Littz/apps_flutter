...
class BlurbCompanyPropertyPage extends StatefulWidget {
  String bizId, bizName;
  BlurbCompanyPropertyPage(this.bizId, this.bizName);

  @override
  _BlurbCompanyPropertyPageState createState() {
    return new _BlurbCompanyPropertyPageState();
  }
}

class _BlurbCompanyPropertyPageState extends State<BlurbCompanyPropertyPage> {
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics().logEvent(name: 'Blurb_Company_'+widget.bizName,parameters:null);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ScopedModel<BlurbScopedModel>(
      ...
      child: Scaffold(
        ...
        body: BlurbPropertyListPage(int.parse(widget.bizId)),
      ),
    );
  }
}

class BlurbPropertyListPage extends StatefulWidget {
  int bizId;
  BlurbPropertyListPage(this.bizId);

  @override
  _BlurbPropertyListBodyState createState() {
    return new _BlurbPropertyListBodyState(bizId: null);
  }
}
...
class _BlurbPropertyListBodyState extends State<BlurbPropertyListPage> {
  ...
  final int bizId;
  _BlurbPropertyListBodyState({@required this.bizId});
