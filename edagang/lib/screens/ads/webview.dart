...
class WebviewBlurb extends StatefulWidget {
  final url, title;
  WebviewBlurb(this.url, this.title);
  @override
  _WebviewBlurbState createState() => _WebviewBlurbState(this.url, this. title);
}

class _WebviewBlurbState extends State<WebviewBlurb> {
  var _url, _title;
  _WebviewBlurbState(this._url, this._title);
  String selectedUrl = '';
