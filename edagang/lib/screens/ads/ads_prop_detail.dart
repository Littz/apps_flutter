...
class PropShowcase extends StatefulWidget {
  String propId, propTitle;
  PropShowcase(this.propId, this.propTitle);

  @override
  _PropShowcasePageState createState() => _PropShowcasePageState();
}

const xpandedHeight = 195.0;

class _PropShowcasePageState extends State<PropShowcase> with TickerProviderStateMixin {
  ...
  getDetails() async {
    ...
    try {
      ...
      setState(() {
        http.post(
          'https://blurbapp.e-dagang.asia/api/blurb/property/details?property_id='+widget.propId,
  ...
  Future share() async {
    ...
    title: 'Blurb',
    text: '',
    linkUrl: 'https://blurbapp.e-dagang.asia/property/',
    chooserTitle: widget.propTitle,
    );
  }
                    ...
                    InkWell(
                      onTap: () async {
                        await FlutterShare.share(
                          title: 'Blurb',
                          text: '',
                          linkUrl: 'https://blurbapp.e-dagang.asia/property/'+_pid.toString(),
                          chooserTitle: ptitle ?? '',
                        );
                      },
                      splashColor: Color(0xffA0CCE8),
